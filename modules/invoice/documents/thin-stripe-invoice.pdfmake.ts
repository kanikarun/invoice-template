...
export class ThinStripeInvoiceDocument extends BaseInvoiceDocument {
  ...
  private price_row(opt: PriceRow): TableCell[] {
    ...
    const text_cell: TableCell = is_empty
      ? { border, text: '' }
      : { style: 'tbl_total', text: title || '', fontSize: 7 };
